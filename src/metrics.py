...
def calculate_partial_match(ground_truth: str, prediction: str) -> float:
    ...
    Args:
        ground_truth: The comma-separated string of expected items.
        prediction: The comma-separated string of predicted items.
    ...
    Returns:
        ...
        Returns 0.0 if the ground_truth is None, empty, or whitespace-only.
    """
